...
public class DataDummy {
    ...
    public static List<CourseEntity> generateDummyCourses() {
        ...
        listCourse.add(new CourseEntity(
                "a14",
        ...
        listCourse.add(new CourseEntity("a55",
        ...
        listCourse.add(new CourseEntity("a47",
        ...
        listCourse.add(new CourseEntity("a74",
        ...
        listCourse.add(new CourseEntity("a51",
    ...
    public static List<ModuleEntity> generateDummyModules(String courseId){
        ...
        ArrayList<ModuleEntity> listModule = new ArrayList<>();

        listModule.add(new ModuleEntity(
                String.format("%sm1", courseId),
                courseId, "Module 0 : Introduction",
                0,
                null));

        listModule.add(new ModuleEntity(String.format("%sm2", courseId),
                courseId,
                "Modul 1 : Teori 1",
                1,
                null));
        listModule.add(new ModuleEntity(String.format("%sm3", courseId),
                courseId,
                "Latihan 1",
                2,
                null));
        listModule.add(new ModuleEntity(String.format("%sm4", courseId),
                courseId,
                "Bedah Kode 1",
                3,
                null));
        listModule.add(new ModuleEntity(String.format("%sm5", courseId),
                courseId,
                "Modul 2 : Teori 2",
                4,
                null));

        listModule.add(new ModuleEntity(String.format("%sm6", courseId),
                courseId,
                "Latihan 2",
                5,
                null));

        listModule.add(new ModuleEntity(String.format("%sm7", courseId),
                courseId,
                "Bedah Kode 2",
                6,
                null));
